...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { course_id: @exam.course_id, date: @exam.date, min_grade: @exam.min_grade, title: @exam.title } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { course_id: @exam.course_id, date: @exam.date, min_grade: @exam.min_grade, title: @exam.title } }
