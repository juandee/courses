...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { exam_id: @grade.exam_id, grade: @grade.grade, pupil_id: @grade.pupil_id } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { exam_id: @grade.exam_id, grade: @grade.grade, pupil_id: @grade.pupil_id } }
